...
export const DragonCursorBg = () => {
  ...
  useEffect(() => {
    ...
    svg.setAttribute("class", "w-full h-full block absolute inset-0");
    
    // SVG Definitions for Dragon in Black and White
    svg.innerHTML = `
      <defs>
        ...
        <g id="Aletas" transform="matrix(1, 0, 0, 1, 0, 0)">
          ...
          <path
            style="fill: url(#LinearGradID_1); stroke: #ffffff; stroke-width: 0.5"
        ...
        <g id="Espina" transform="matrix(1, 0, 0, 1, 0, 0)">
          ...
          <path
            style="fill: url(#LinearGradID_2); stroke: #ffffff; stroke-width: 0.5"
    ...
    return () => {
      ...
      if (container && svg.parentNode === container) {
